...
function mostrarCarrito() {
    ...
    const carritoCombinado = carritoPagina2.concat(carritoPagina21, carritoPagina22);
...
function sumarProducto(index) {
    ...
    let carritoCombinado = carritoPagina2.concat(carritoPagina21, carritoPagina22);
